...
const ICON_PIN_SOURCE = L.icon(
    options = {
        iconUrl: './src/img_file/source-pin.svg',
...
const ICON_BI_SOURCE = L.icon(
    options = {
        iconUrl: './src/img_file/source-bi.svg',
...
const ICON_PIN_DES = L.icon(
    options = {
        iconUrl: './src/img_file/des-pin.svg',
...
const ICON_BI_DES = L.icon(
    options = {
        iconUrl: './src/img_file/des-bi.svg',
